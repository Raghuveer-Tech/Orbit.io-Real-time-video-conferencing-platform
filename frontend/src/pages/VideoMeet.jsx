...
// STUN alone is enough for most users, but participants behind strict/symmetric
// NATs or corporate firewalls often can't establish a direct P2P path with only
// STUN — they need a TURN server to relay media. Set these in your .env if you
// have TURN credentials (e.g. from Twilio, Metered, or a self-hosted coturn):
//   REACT_APP_TURN_URL, REACT_APP_TURN_USERNAME, REACT_APP_TURN_CREDENTIAL
// If unset, the app falls back to STUN-only (current behavior).
...
// Meeting codes generated by this app are short alphanumeric strings
// Anything that doesn't look like that is rejected up front — this stops
// random/garbage text typed into the URL bar from immediately triggering
// a camera/mic permission prompt and the full call lobby UI.
const MEETING_CODE_REGEX = /^[a-zA-Z0-9-]{4,40}$/;

function VideoMeetComponent() {
    const { url: meetingCodeParam } = useParams();
    const navigate = useNavigate();
    const isValidMeetingCode = MEETING_CODE_REGEX.test(meetingCodeParam || "");
    ...
    let connectToSocketServer = () => {
        ...
        socketRef.current.on('connect', () => {
            ...
            // Server (id, clients, namesMap, hostSocketId)
    ...
    let endCallCleanup = () => {
        ...
        // Logged-in user ko /home pe bhejo, guest  ko landing page (/) pe
                ...
                <div className={styles.lobbyContainer}>
                    <div className={styles.lobbyCard}>
                        ...
                        <p className={styles.lobbySubText}>
                            This meeting code doesn't look right. Please double-check the link
                            or ask the host to share it again.
                        </p>
                        <Button
                            variant="contained"
